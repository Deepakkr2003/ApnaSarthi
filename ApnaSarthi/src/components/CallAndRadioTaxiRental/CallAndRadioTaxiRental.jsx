...
import taxi1 from "../../assets/Taxi1.jpeg"

function CallAndRadioTaxiRental() {
  

  return (
    <div className="mx-2 md:mx-8 bg-gray-200 border-4 border-blue-600 rounded-xl shadow-md overflow-hidden  my-4">
    <h1 className='text-center text-indigo-700 uppercase text-2xl font-semibold '>Call And Radio Taxi</h1>
    <div className='flex justify-around mt-4'>
      ...
      <div>
        ...
        <h1 className=' mt-4'>• Taxi</h1>
        <h1 className=' mt-1'>• etc...</h1>
        <img src={taxi1} alt="" className="w-48 h-48 mt-4 rounded-xl border-4 border-blue-600"/>
...
export default CallAndRadioTaxiRental;
