...
function CommercialVehicleService() {
 
  return (
    <div className="mx-2 md:mx-8 bg-gray-200 border-4 border-blue-600 rounded-xl shadow-md overflow-hidden  my-4">
    <h1 className='text-center text-indigo-700 uppercase text-2xl font-semibold '>Commercial Vehicle </h1>
    <div className='flex justify-around mt-4'>
      ...
      <div>
        <h1 className='text-xl font-medium'>Commerical Vehicle</h1>
          ...
          <div >
            ...
            <h1>• Tata Ace EV</h1>
            <h1>• etc...</h1>
            <img src={truck1} alt="" className="w-48 h-48 mt-4 rounded-xl border-4 border-blue-600"/>
          </div>
