...
function SelfDrivingRentalService() {
  
  return (
    <div className="mx-2 md:mx-8 bg-gray-200 border-4 border-blue-600 rounded-xl shadow-md overflow-hidden my-4">
    <h1 className='text-center text-indigo-700 uppercase text-2xl font-semibold '>Self Driving</h1>
...
export default SelfDrivingRentalService