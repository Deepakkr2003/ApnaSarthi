...
import tempo1 from "../../assets/Auto1.jpeg"

function VanAndTempoRentalService() {
  
  return (
    <div className="  bg-gray-200 border-4 border-blue-600 rounded-xl shadow-md overflow-hidden mx-2 md:mx-8 my-4">
    <h1 className='text-center text-indigo-700 uppercase text-2xl font-semibold '>Van And Tempo Rental</h1>
    <div className='flex justify-around mt-4'>
      ...
      <div>
        ...
        <div className='flex justify-between md:space-x-16 mt-4'>
          <div >
            <h1 className='font-semibold '>• Van</h1>
            <h1 className='mt-1 '>• etc...</h1>
            <img src={van1} alt="" className="w-48 h-48 mt-4 rounded-xl border-4 border-blue-600"/>
            
          </div>
          <div >
            <h1 className='font-semibold '>• Tempo</h1>
            <h1 className='mt-1 '>• etc...</h1>
            <img src={tempo1} alt="" className="w-48 h-48 mt-4 rounded-xl border-4 border-blue-600"/>
    ...
    <div className='mt-8 ml-6 mb-4 text-center'>
      <h1 className='text-2xl font-semibold '>For Booking</h1>
...
export default VanAndTempoRentalService